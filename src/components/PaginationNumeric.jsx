...
function PaginationNumeric({pagination, setPage, page}) {
  const numberOfPages = [];
    ...
    <>
      <div className="flex justify-center">
        <nav className="flex" role="navigation" aria-label="Navigation">
          ...
          <div className="ml-2">
            <a href="#0" onClick={()=>setPage(page++)} className="inline-flex items-center justify-center rounded leading-5 px-2.5 py-2 bg-white hover:bg-blue-500 border border-slate-200 text-slate-600 hover:text-white shadow-sm">
